...
public class MainLibrary {
	...
	public static void main(String[] args) {
		...
		// create library single instance
		...
		/**
		 * Create Random books with the above authors
		 */
		...
		Book book19 = new Book("Book19", ruth, "368777230-2", 10, 3, 20);
		...
		/**
		 * Librarian, undertakes the operation of the library
		 */
		Librarian employee = new Librarian("George", 23325);
		library.setLibrarian(employee);
		// list all available books
		employee.findMeAvailableBooks(library.getBooks());
		// find book entitled Book1
		employee.findMeBook("Book1", library.getBooks());
		// find books of Lisa
		employee.findMeBooksFromAuthor("Lisa", library.getBooks());
		// find the most popular book
		System.out.println("Most popular book: " + 
					employee.findMostPopularBook(library.getBooks()));
	}
}
